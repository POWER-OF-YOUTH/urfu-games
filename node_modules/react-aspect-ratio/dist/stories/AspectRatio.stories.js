...
exports.IFrame = exports.Gallery = exports.BackgroundImage = exports.ImageNumberAsRatio = exports.ImageStringAsRatio = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const index_1 = require("../index");
require("../../aspect-ratio.css");
require("../../theme.css");
function PageTitle() {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "page__title", children: [(0, jsx_runtime_1.jsxs)("h1", { className: "page__title-main", children: ["React Apect Ratio", (0, jsx_runtime_1.jsx)("a", { className: "github mui-icon", href: "https://github.com/roderickhsiao/react-aspect-ratio", target: "_blank", rel: "noopener noreferrer", title: "github", children: (0, jsx_runtime_1.jsx)("span", { style: { visibility: 'hidden' }, children: " Github " }) })] }), (0, jsx_runtime_1.jsx)("p", { className: "page__title-desc", children: "prevent reflow by preserving aspect ratio of your component" })] }));
}
const lorem = `
...
`;
function Card({ titleText, contentNode, }) {
    return ((0, jsx_runtime_1.jsxs)("div", { className: "card", children: [(0, jsx_runtime_1.jsx)("div", { className: "card__head", children: (0, jsx_runtime_1.jsx)("h3", { className: "card__title", children: titleText }) }), (0, jsx_runtime_1.jsx)("div", { className: "card__conent", children: contentNode })] }));
}
exports.default = {
    title: 'Aspect Ratio',
    component: index_1.AspectRatio,
};
function ImageStringAsRatio() {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(PageTitle, {}), (0, jsx_runtime_1.jsx)(Card, { titleText: "Image with Aspect Ratio", contentNode: ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(index_1.AspectRatio, { ratio: "300/165", style: { maxWidth: '300px', margin: 'auto' }, children: (0, jsx_runtime_1.jsx)("img", { src: "https://upload.wikimedia.org/wikipedia/en/7/7d/Minions_characters.png", alt: "demo" }) }), (0, jsx_runtime_1.jsx)("p", { children: lorem })] })) })] }));
}
exports.ImageStringAsRatio = ImageStringAsRatio;
ImageStringAsRatio.storyName = 'Image (string as props)';
function ImageNumberAsRatio() {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(PageTitle, {}), (0, jsx_runtime_1.jsx)(Card, { titleText: "Image with Aspect Ratio (pass number as props)", contentNode: ((0, jsx_runtime_1.jsx)(index_1.AspectRatio, { ratio: 0.75, style: { maxWidth: '400px' }, children: (0, jsx_runtime_1.jsx)("img", { src: "https://c1.staticflickr.com/4/3896/14550191836_cc0675d906.jpg", alt: "demo" }) })) })] }));
}
exports.ImageNumberAsRatio = ImageNumberAsRatio;
ImageNumberAsRatio.storyName = 'Image (number as props)';
function BackgroundImage() {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(PageTitle, {}), (0, jsx_runtime_1.jsx)(Card, { titleText: "Background image with aspect ratio", contentNode: ((0, jsx_runtime_1.jsx)(index_1.AspectRatio, { ratio: "3/4", style: {
                        maxWidth: '300px',
...
function Gallery() {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(PageTitle, {}), (0, jsx_runtime_1.jsx)(Card, { titleText: "Image Gallery with Aspect Ratio", contentNode: ((0, jsx_runtime_1.jsx)("div", { className: "gallery", children: images.map((image) => ((0, jsx_runtime_1.jsx)("div", { className: "gallery__image", children: (0, jsx_runtime_1.jsx)(index_1.AspectRatio, { ratio: image.ratio, children: (0, jsx_runtime_1.jsx)("img", { src: image.src, alt: "demo" }) }) }, image.src))) })) })] }));
}
exports.Gallery = Gallery;
function IFrame() {
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(PageTitle, {}), (0, jsx_runtime_1.jsx)(Card, { titleText: "Iframe with aspect ratio", contentNode: ((0, jsx_runtime_1.jsx)(index_1.AspectRatio, { ratio: "560/315", style: { maxWidth: '560px' }, children: (0, jsx_runtime_1.jsx)("iframe", { src: "https://www.youtube.com/embed/Sv6dMFF_yts", frameBorder: "0", allowFullScreen: true, title: "youtube" }) })) })] }));
}
