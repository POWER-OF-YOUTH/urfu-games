...
API_URI="https://api.158.160.20.41.com"
FILES_URI="https://files.158.160.20.41.com"
YM_ID=0
...
mkdir -p $BUILD_DIR/var/www/files.158.160.20.41.com
echo "Done."

echo "Building frontend..."
mkdir -p $BUILD_DIR/var/www/158.160.20.41.com
cd $PROJECT_DIR/frontend
yarn install
API_URI=$API_URI FILES_URI=$FILES_URI yarn build
cp -r $PROJECT_DIR/frontend/build/* $BUILD_DIR/var/www/158.160.20.41.com/
echo "Done."
