...
API_URI="https://api.trajector.ru"
FILES_URI="https://files.trajector.ru"
YM_ID=0
...
mkdir -p $BUILD_DIR/var/www/files.trajector.ru
echo "Done."

echo "Building frontend..."
mkdir -p $BUILD_DIR/var/www/trajector.ru
cd $PROJECT_DIR/frontend
yarn install
API_URI=$API_URI FILES_URI=$FILES_URI yarn build
cp -r $PROJECT_DIR/frontend/build/* $BUILD_DIR/var/www/trajector.ru/
echo "Done."
